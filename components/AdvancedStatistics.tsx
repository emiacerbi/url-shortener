...
function AdvancedStatistics() {
  return (
    <section>
      <Wrapper>
        <div className="text-center text-base px-6 mt-20">
          ...
          <ul className="grid gap-20 mt-20 relative z-0">
            ...
            {statistics.map((obj) => (
              <li key={obj.id} className="bg-white p-6 shadow-md grid gap-3">
                <div className="bg-primary-800 rounded-full w-20 h-20 grid place-content-center mx-auto -mt-16">
